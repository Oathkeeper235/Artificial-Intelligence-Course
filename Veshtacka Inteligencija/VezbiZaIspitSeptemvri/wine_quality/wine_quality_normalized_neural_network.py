...
from wine_quality_neural_networks import read_dataset, divide_sets
...
if __name__ == '__main__':
    ...
    print(f'Bez normalizacija imame tochnost so validacisko mnozhestvo od {val_acc1}')
    ...
    print(f'So standardna normalizacija imame tochnost so validacisko mnozhestvo od {val_acc2}')
