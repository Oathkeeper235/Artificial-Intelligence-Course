...
def check_ifValid_position(x, y):
...
def check_move_straight(next_move, x, y, direction, dots):
    if check_ifValid_position(x, y):
        new_dots = check_dots(x, y, dots)
        next_move["ProdolzhiPravo"] = (x, y, direction, new_dots)


def continute_straight(next_move, x, y, direction, dots):
    if direction == "istok":
        newX = x + 1
        newY = y
    ...
    check_move_straight(next_move, newX, newY, direction, dots)


def check_move_back(next_move, x, y, direction, dots):
    if check_ifValid_position(x, y):
        new_dots = check_dots(x, y, dots)
        next_move["ProdolzhiNazad"] = (x, y, direction, new_dots)


def continue_back(next_move, x, y, direction, dots):
    if direction == "istok":
        newX = x - 1
        newY = y
        new_direction = "zapad"
    ...
    check_move_back(next_move, newX, newY, new_direction, dots)


def check_move_left(next_move, x, y, direction, dots):
    if check_ifValid_position(x, y):
        new_dots = check_dots(x, y, dots)
        next_move["SvrtiLevo"] = (x, y, direction, new_dots)


def turn_left(next_move, x, y, direction, dots):
    if direction == "istok":
        newX = x
        newY = y + 1
        new_direction = "sever"
    ...
    check_move_left(next_move, newX, newY, new_direction, dots)


def check_move_right(next_move, x, y, direction, dots):
    if check_ifValid_position(x, y):
        new_dots = check_dots(x, y, dots)
        next_move["SvrtiDesno"] = (x, y, direction, new_dots)


def turn_right(next_move, x, y, direction, dots):
    if direction == "istok":
        newX = x
        newY = y - 1
        new_direction = "jug"
    ...
    check_move_right(next_move, newX, newY, new_direction, dots)
...
class Pacman(Problem):
    ...
    def successor(self, state):
        ...
        # continue straight
        continute_straight(next_move, x, y, direction, dots)

        # continue back
        continue_back(next_move, x, y, direction, dots)

        # turn left
        turn_left(next_move, x, y, direction, dots)

        # turn right
        turn_right(next_move, x, y, direction, dots)
